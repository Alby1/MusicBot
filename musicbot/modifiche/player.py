...
class MusicPlayer(EventEmitter, Serializable):
    ...
    # Ma se facessimo...
    canzoni_radio = {
        "Your Gaming": "https://www.youtube.com/watch?v=HOZoFi-U16A",
        "Pubblicità": "https://www.youtube.com/watch?v=Uwu1bofjQTw",
        "Ad1" : "https://youtu.be/ueTIlkioWfQ",  
        "Ad2" : "https://www.youtube.com/watch?v=mMVSa316eco",
        "Ad3" : "https://youtu.be/HDe6dTDe8es"
    }
        ...
        with await self._play_lock:
            if self.is_stopped or _continue:
                ...
                if self.contatore == 20 :
                    entry = await self.playlist.add_entry(self.canzoni_radio["Your Gaming"])
                    print("Radio Ubaldo, Your Gaming")
                if self.contatore == 24 :
                    entry = await self.playlist.add_entry(self.canzoni_radio["Your Gaming"])
                    print("Radio Ubaldo, Your Gaming")
                if self.contatore == 28 :
                    entry = await self.playlist.add_entry(self.canzoni_radio["Your Gaming"])
                    print("Radio Ubaldo, Your Gaming")
                if self.contatore == 32 :
                    entry = await self.playlist.add_entry(self.canzoni_radio["Pubblicità"])
                    entry = await self.playlist.add_entry(self.canzoni_radio["Ad2"])
                    print("Pubblicità\nAd2")
                if self.contatore == 36 :
                    entry = await self.playlist.add_entry(self.canzoni_radio["Your Gaming"])
                    print("Radio Ubaldo, Your Gaming")
                if self.contatore == 40 :
                    entry = await self.playlist.add_entry(self.canzoni_radio["Your Gaming"])
                    print("Radio Ubaldo, Your Gaming")        
                if self.contatore == 44 :
                    entry = await self.playlist.add_entry(self.canzoni_radio["Your Gaming"])
                    print("Radio Ubaldo, Your Gaming")    
                if self.contatore == 48 :
                    entry = await self.playlist.add_entry(self.canzoni_radio["Ad3"])
                    print("Pubblicità\nAd3")   
                    self.contatore = 0
